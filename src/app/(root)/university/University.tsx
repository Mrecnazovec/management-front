	...
	return (
		<AOSComponent>
			<Container className='overflow-x-hidden'>
				...
				<p className='text-base mb-14' data-aos='fade-up'>
				...
				<h2 className='text-3xl mb-4' data-aos='fade-up'>
					О направлении:
				</h2>
				<p className='text-paragraph mb-2' data-aos='fade-up'>
					Направление Менеджмент было открыто в 2023/2024 учебном году.
				</p>
				<p className='text-paragraph mb-8' data-aos='fade-up'>
