	...
	return (
		<AOSComponent>
			<Container className='lg:min-h-[800px] sm:min-h-[500px]'>
				<h1 className='text-3xl mb-10' data-aos='fade-up'>
					{person.name}
				</h1>

				<div className='mb-14 clearfix' data-aos='fade-up'>
				...
				<div className='grid md:grid-cols-4 grid-cols-2 gap-4 mb-10' data-aos='fade-up'>
				...
				<div className='grid md:grid-cols-4 grid-cols-2 gap-4' data-aos='fade-up'>
